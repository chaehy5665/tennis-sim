...
namespace TennisSim.Viewer
{
    public static class ReplayLoader
    {
        ...
        public static ReplayData Parse(string json, string fileName = "memory.json")
        {
            ...
            if (Text(root, "engineVersion") != "tennissim-mvp-1" && Text(root, "engineVersion") != "tennissim-mvp-2" && Text(root, "engineVersion") != "tennissim-mvp-3" && Text(root, "engineVersion") != "tennissim-mvp-4" && Text(root, "engineVersion") != "tennissim-mvp-5") throw new FormatException("Unsupported engineVersion / coordinate contract");
