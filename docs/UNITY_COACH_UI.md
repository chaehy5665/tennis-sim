...
## 2026-09-24 Mac 시각 확인 결과와 수정

Mac 세션이 커밋 a0a11cd를 Unity 6000.6.0f1, 1280×800에서 확인했다. 디자인 점검 항목(서체, 색, 포커스, 1px 테두리, 배너,
서브권 점, StepNav, 히트맵 색)은 모두 통과했다. 레이아웃 8건은 아래처럼 고쳤다(디자인 시스템 v10 "글과 배치" 절).
